...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(json.success)
    {
        //saving auth token and redirect to main page
    localStorage.setItem('token', json.authtoken)
    navigate("/")
    props.showAlert("Good Job! you have created your account on conor cloud", "success")
    }
    else{
    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="email" className="form-control" id="name" aria-describedby="emailHelp" name="email" onChange={onChange} />
